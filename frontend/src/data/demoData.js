...
export const demoOrders = [
  { id: 1, order_number: 'ORD-1001', quote_id: 'Q-1042', quote_number: 'Q-1042', customer: 'Northline Studio', status: 'Confirmed', production_status: 'In production', delivery_date: '2026-10-18', installation_status: 'Scheduled', amount: 186400, notes: 'Demo project order', updates: [{ id: 1, body: 'Materials confirmed and production slot reserved.', author: 'Aarav Admin', created_at: '2026-09-18T10:00:00.000Z' }] },
]
...
export const demoPurchaseOrders = [{ id: 1, po_number: 'PO-3001', supplier_id: 1, supplier: 'Oak & Co. Furnishings', status: 'Confirmed', order_date: '2026-09-19', expected_date: '2026-10-05', supplier_quote_ref: 'OAK-Q-104', landed_cost: 275000, quality_rating: 4.5, total: 260000, items: [{ id: 1, product_id: 1, description: 'Aster Modular Sofa', quantity: 4, unit_cost: 65000, line_total: 260000 }] }]
...
export const demoSchedules = [{ id: 1, order_id: 1, order_number: 'ORD-1001', customer: 'Northline Studio', schedule_type: 'Delivery', scheduled_date: '2026-10-18', time_slot: '10:00–12:00', eta: '10:30 AM', customer_confirmed: true, assigned_team: 'North Delhi delivery team', status: 'Scheduled', proof_url: '', notes: '' }, { id: 2, order_id: 1, order_number: 'ORD-1001', customer: 'Northline Studio', schedule_type: 'Installation', scheduled_date: '2026-10-20', time_slot: '09:00–13:00', eta: '09:15 AM', customer_confirmed: false, assigned_team: 'Furnivo installation team', status: 'Scheduled', proof_url: '', notes: '' }]
...
export const demoProductionJobs = [{ id: 1, job_number: 'JOB-5001', order_id: 1, order_number: 'ORD-1001', customer: 'Northline Studio', status: 'Assembly', scheduled_start: '2026-09-24', due_date: '2026-10-10', assigned_team: 'North workshop team', wastage_percent: 5, notes: 'Demo job card generated from approved quote.', bom_items: [{ id: 1, product_id: 1, product: 'Aster Modular Sofa', description: 'Aster Modular Sofa', quantity: 2, unit: 'set', wastage_percent: 5, planned_quantity: 2.1, unit_cost: 42000, labor_cost: 15876, material_cost: 88200, total_cost: 104076, status: 'Required' }, { id: 2, product_id: 2, product: 'Halo Pendant Light', description: 'Halo Pendant Light', quantity: 2, unit: 'piece', wastage_percent: 3, planned_quantity: 2.06, unit_cost: 6200, labor_cost: 2298.96, material_cost: 12772, total_cost: 15070.96, status: 'Required' }] }]
export const demoPlanning = { summary: { jobs: 1, materials: 2, shortages: 0, low_stock_items: 0, material_cost: 100972, labor_cost: 18174.96, estimated_cost: 119146.96 }, jobs: [{ id: 1, job_number: 'JOB-5001', order_number: 'ORD-1001', customer: 'Northline Studio', status: 'Assembly', due_date: '2026-10-10', material_cost: 100972, labor_cost: 18174.96, estimated_cost: 119146.96, shortage_count: 0 }], materials: [{ id: 1, inventory_id: 1, job_id: 1, job_number: 'JOB-5001', product_id: 1, product: 'Aster Modular Sofa', description: 'Aster Modular Sofa', unit: 'set', required_quantity: 2.1, available_quantity: 10, reserved_quantity: 2, shortage_quantity: 0, unit_cost: 42000, material_cost: 88200, labor_cost: 15876, total_cost: 104076, supplier: 'Oak & Co. Furnishings', location: 'Delhi warehouse' }, { id: 2, inventory_id: 2, job_id: 1, job_number: 'JOB-5001', product_id: 2, product: 'Halo Pendant Light', description: 'Halo Pendant Light', unit: 'piece', required_quantity: 2.06, available_quantity: 19, reserved_quantity: 5, shortage_quantity: 0, unit_cost: 6200, material_cost: 12772, labor_cost: 2298.96, total_cost: 15070.96, supplier: 'Halo Lighting Works', location: 'Delhi warehouse' }], purchase_suggestions: [], inventory: demoInventory }
export const demoAutomationTemplates = [{ event: 'quote_approved', label: 'Quote approved', title: 'Quotation approved', body: '{{quote_number}} for {{customer}} has been approved.', channels: ['in_app', 'email', 'whatsapp'] }, { event: 'deposit_paid', label: 'Deposit paid', title: 'Deposit payment received', body: 'The deposit for {{order_number}} has been received. Production can proceed.', channels: ['in_app', 'email', 'whatsapp'] }, { event: 'production_update', label: 'Production update', title: 'Production update', body: '{{order_number}} is now at the {{status}} stage.', channels: ['in_app', 'email', 'whatsapp'] }, { event: 'delivery_reminder', label: 'Delivery reminder', title: 'Delivery reminder', body: '{{order_number}} is scheduled for delivery on {{delivery_date}}.', channels: ['in_app', 'email', 'whatsapp'] }, { event: 'support_update', label: 'Support update', title: 'Support request updated', body: 'Support request {{ticket_number}} is now {{status}}.', channels: ['in_app', 'email', 'whatsapp'] }]
...
export const demoContracts = [{ id: 1, contract_number: 'CTR-7001', quote_id: 'Q-1042', quote_number: 'Q-1042', customer: 'Northline Studio', title: 'Northline Studio project agreement', terms: '1. Furnivo will deliver the approved scope and materials listed in the quotation.\n2. Production begins after written approval and agreed advance payment.\n3. Delivery and installation dates are scheduled after material confirmation.', status: 'Sent', locked: false, signed_at: null, signatures: [] }]
...
export const demoAnalytics = { summary: { revenue: 50000, invoice_total: 186440, outstanding: 136440, quote_pipeline: 514900, conversion_rate: 33.3, lead_win_rate: 25, inventory_value: 1877200, low_stock: 0 }, profitability: { revenue: 186400, estimated_cost: 119146.96, gross_profit: 67253.04, margin_percent: 36.1, projects: [{ order_number: 'ORD-1001', customer: 'Northline Studio', revenue: 186400, estimated_cost: 119146.96, gross_profit: 67253.04, margin_percent: 36.1 }], top_products: [{ product: 'Aster Modular Sofa', revenue: 157000, estimated_cost: 84000, gross_profit: 73000, margin_percent: 46.5, quantity: 2 }] }, quotes_by_status: [{ label: 'Sent', count: 1 }, { label: 'Draft', count: 1 }, { label: 'Approved', count: 1 }], leads_by_stage: [{ label: 'New', count: 1 }, { label: 'Qualified', count: 1 }, { label: 'Proposal', count: 1 }, { label: 'Won', count: 1 }], production_by_status: [{ label: 'Assembly', count: 1 }], forecast: { next_30_days: 230215, next_90_days: 436175, method: 'Collected revenue plus weighted open pipeline' }, top_customers: [{ customer: 'Northline Studio', value: 186440 }] }
export const demoIntegrations = [{ id: 1, name: 'Demo accounting workspace', provider: 'Zoho Books', external_account: 'Furnivo Demo Books', credentials_ref: 'env:ZOHO_BOOKS_TOKEN', status: 'Connected', is_enabled: true, last_sync_at: '2026-09-22T08:30:00Z' }]
export const demoSyncRuns = [{ id: 1, connection_id: 1, provider: 'Zoho Books', entity: 'invoices', status: 'Complete', records_synced: 1, error: '', started_at: '2026-09-22T08:30:00Z', completed_at: '2026-09-22T08:30:03Z' }]
export const demoFieldVisits = [{ id: 1, order_id: 1, order_number: 'ORD-1001', customer: 'Northline Studio', visit_type: 'Installation', status: 'Scheduled', assigned_to_id: 2, assigned_to: demoUsers[1], scheduled_date: '2026-10-20', qr_token: 'FURNIVO-DEMO1001', proof_photo_url: '', customer_signature: '', gps_lat: null, gps_lng: null, check_in_at: null, check_out_at: null, time_minutes: 0, materials: [], notes: 'Scan the project QR at arrival.', offline_synced: true }]
