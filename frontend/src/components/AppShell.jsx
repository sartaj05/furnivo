...
const navItems = [
  ...
  { to: '/app/invoices', label: 'Invoices & payments', shortLabel: 'Invoices', roles: ['admin', 'sales', 'client', 'accountant'] },
  { to: '/app/gst', label: 'GST & e-invoicing', shortLabel: 'GST', roles: ['admin', 'sales', 'client', 'accountant'] },
  { to: '/app/payment-reconciliation', label: 'Payment reconciliation', shortLabel: 'Reconcile', roles: ['admin', 'sales', 'client', 'accountant'] },
  ...
  { to: '/app/accounting-center', label: 'Accounting control center', shortLabel: 'Accounts', roles: ['admin', 'sales', 'accountant'] },
  ...
  { to: '/app/field-operations', label: 'Field operations', shortLabel: 'Field', roles: ['admin', 'sales', 'designer', 'client', 'installer'] },
  { to: '/app/mobile-workshop', label: 'Mobile workshop', shortLabel: 'Workshop', roles: ['admin', 'designer', 'workshop_operator'] },
  { to: '/app/schedules', label: 'Delivery & installation', shortLabel: 'Schedule', roles: ['admin', 'sales', 'designer', 'client', 'installer'] },
